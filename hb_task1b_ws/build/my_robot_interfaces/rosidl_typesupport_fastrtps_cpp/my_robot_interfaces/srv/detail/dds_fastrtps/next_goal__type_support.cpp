...
#include "my_robot_interfaces/srv/detail/next_goal__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_robot_interfaces::srv::NextGoal_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::srv::NextGoal_Request & ros_message)
{
  // Member: request_goal
  cdr >> ros_message.request_goal;
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::srv::NextGoal_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::srv::NextGoal_Request *>(
    untyped_ros_message);
...
get_message_type_support_handle<my_robot_interfaces::srv::NextGoal_Request>()
{
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_NextGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, NextGoal_Request)() {
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_NextGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_robot_interfaces
cdr_serialize(
  const my_robot_interfaces::srv::NextGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: x_goal
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::srv::NextGoal_Response & ros_message)
{
  // Member: x_goal
  cdr >> ros_message.x_goal;
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::srv::NextGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::srv::NextGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_my_robot_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<my_robot_interfaces::srv::NextGoal_Response>()
{
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_NextGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, NextGoal_Response)() {
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_NextGoal_Response__handle;
}
...
get_service_type_support_handle<my_robot_interfaces::srv::NextGoal>()
{
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_NextGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, NextGoal)() {
  return &my_robot_interfaces::srv::typesupport_fastrtps_cpp::_NextGoal__handle;
}
